...
function Router() { return <Switch><Route path="/" component={Home} /><Route path="/video" component={Video} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>; }
